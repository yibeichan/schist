...
- `create_note`, `create_concept`, `update_note`, `delete_note`, `add_connection`, `sync_retry` — vault/sync write
...
Markdown writes (`create_note`, `create_concept`, `update_note`, `delete_note`,
and `add_connection`) are additionally
