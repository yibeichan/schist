...
export interface ToolError {
  error: string;  // NOT_FOUND | PATH_TRAVERSAL | WRITE_TIMEOUT | GIT_ERROR | INVALID_SQL | VALIDATION_ERROR | INGEST_ERROR | INVALID_ARG | CURSOR_REQUIRED | CURSOR_EXPIRED | CURSOR_INVALID_SIGNATURE | CURSOR_WRONG_TOOL | CURSOR_STALE | CURSOR_QUERY_MISMATCH | ACL_DENIED | SYNC_DIRTY | TOOL_REMOVED | IO_ERROR | COLLISION_RETRIES_EXHAUSTED
  message: string;
  details?: unknown;
}
