...
export interface ToolError {
  error: string;  // NOT_FOUND | PATH_TRAVERSAL | WRITE_TIMEOUT | GIT_ERROR | INVALID_SQL | VALIDATION_ERROR | INGEST_ERROR | INVALID_ARG | CURSOR_REQUIRED | CURSOR_EXPIRED | CURSOR_INVALID_SIGNATURE | CURSOR_WRONG_TOOL | ACL_DENIED | TOOL_REMOVED
  message: string;
  details?: unknown;
}
